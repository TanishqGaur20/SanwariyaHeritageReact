...
const Facilities = () => {
  ...
  return (
    <main data-aos="fade-up" data-aos-delay="0" data-aos-offset="150" data-aos-easing="ease-in-sine" data-aos-duration="400" className="bg-white-100  w-full h-full">
      <img src='/divider.png' alt="diver" className="w-[97%] block mx-auto" />
      <section className="py-10 lg:py-14  px-5 md:px-[1.9rem] largesceen:px-14 fourk:px-44 sm:pt-16 desktop:pt-28 largesceen:pt-44 flex flex-col sm:flex-row justify-between">
        <div className="flex flex-col justify-between">
          ...
          <div>
            <img src="/facility2.png" alt="facility image" className="lg:w-[14.438rem] desktop:w-[20.938rem] largesceen:w-[27.688rem] hidden sm:block"  />
          </div>
        </div>
          ...
          <div className="sm:mb-14 lg:mb-36">
            <h2 className="text-gradient uppercase text-[3.2rem] leading-none lg:text-[6rem] desktop:text-[7.813rem] largesceen:text-[9.375rem] xs:ml-16 sm:ml-0 max-sm:mb-12">
              ...
              <span className="flex w-fit">
                <img src={star8} alt="star" className=" lg:w-[50px] mx-6 sm:mx-8 lg:mx-[4rem] desktop:mx-[5rem] largesceen:mx-[6.875rem] h-auto animi-1" /> lities
              </span>
            </h2>

            <div>
              <img src="/facility2.png" alt="facility image" className="lg:w-[14.438rem] desktop:w-[20.938rem] largesceen:w-[27.688rem] sm:hidden" />
            </div>
          </div>
        ...
        <div className="relative hidden sm:block">
          <img src="/facility1.png" alt="facility image" className="lg:w-[14.438rem] desktop:w-[20.938rem] largesceen:w-[27.688rem]"/>
          {/* <img
            src={label}
            alt="label"
      ...
      <section
        ...
        <div>
          <img src="/space-copenhagen-the-stratford-architonic-jw4-04-arcit18 1.png" alt="ice room" className="lg:w-[22.25rem] desktop:w-[28.313rem] largesceen:w-[37.5rem]"  />
        </div>
      </section>
      <img src='/divider.png' alt="diver" className="w-[97%] block mx-auto" />
      ...
      <section
        ...
        <div>
          <img src="/conference.jpg" alt="ice room" className="lg:w-[22.25rem] desktop:w-[28.313rem] largesceen:w-[37.5rem] h-[26.5rem] largesceen:h-full"  />
        </div>
      </section>
      <img src='/divider.png' alt="diver" className="w-[97%] block mx-auto" />
      ...
      <section
        ...
        <div>
          <img src='https://www.gannett-cdn.com/presto/2019/02/27/USAT/52c2114d-9f01-48b4-b9fd-0f29fb4bd542-ang_Oceanfront_Infinity_Pool_at_Anguillas_Zemi_Beach_House_Hotel__Spa_is_the_go-to_for_relaxation_Credit_Dylan_Cross_Tambourine.jpg?crop=3999,2249,x0,y303&width=3200&height=1680&fit=bounds' width={500} height={500} alt="pool" className="lg:w-[22.25rem] desktop:w-[28.313rem] largesceen:w-[37.5rem] h-[26.5rem] largesceen:h-full object-cover"  />
        </div>
      </section>
      ...
      <section
        ...
        />
        <img src={vector} alt="diver" className="hidden xs:block absolute bottom-0  sm:-bottom-4 md:-bottom-20 largesceen:-bottom-60 right-0 largesceen:w-full"  />
